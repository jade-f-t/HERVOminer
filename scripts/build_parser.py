...
def build_parser():
	...
	quantification_parser.add_argument("-a", "--annotation", required = True, help = "path to the annotation file created by function 3", dest = "annotationFile")
	...
	outputResult_parser.add_argument("-T", "--tumour_quantification_result", required=True, help = "path of csv file with path to the tumour samples quantification result", dest = "tumourResultDirectories")
	outputResult_parser.add_argument("-N", "--normal_quantification_result", required=True, help = "path of csv file with path to the normal samples quantification result", dest = "normalResultDirectories")
